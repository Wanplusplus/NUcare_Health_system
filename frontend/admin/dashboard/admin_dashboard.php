...
<div class="app-shell">
 ...
 <a href="/NUcare_Health_system/frontend/admin/user_management.php" class="adm-action-card">
 ...
 <?php if ($isSuperAdmin): ?>
 <a href="/NUcare_Health_system/frontend/admin/rbac_management.php" class="adm-action-card">
 ...
 <a href="/NUcare_Health_system/frontend/admin/audit_logs.php" class="adm-action-card">
 ...
 <a href="/NUcare_Health_system/frontend/admin/reports.php" class="adm-action-card">
...
(function () {
 ...
 const AJAX_URL = '/NUcare_Health_system/backend/ajax/dashboard_stats.ajax.php';

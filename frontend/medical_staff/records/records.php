...
<div class="app-shell">
 ...
 <span><i class="fa-solid fa-id-card"></i> <span id="modalPatientID">None</span></span>
 <span><i class="fa-solid fa-user-tag"></i> <span id="modalPatientType">None</span></span>
 <span><i class="fa-solid fa-venus-mars"></i> <span id="modalPatientSex">None</span></span>
 <span><i class="fa-solid fa-book-open"></i> <span id="modalPatientProgram">None</span></span>
 </div>
 </div>
 </div>

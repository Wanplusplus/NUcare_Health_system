...
<div class="app-shell">
 ...
 method="POST"
 action="/NUcare_Health_system/backend/ajax/consultation/save_consultation.ajax.php"
 ...
 <div class="form-group">
 <label for="consultTemp">Temperature ( degC)</label>
 ...
 <div class="form-group">
 <label for="peTemp">Temperature ( degC)</label>

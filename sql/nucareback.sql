...
--
-- Table structure for table `role_permissions_backup_20260604`
--

CREATE TABLE `role_permissions_backup_20260604` (
  `RolePermissionID` int NOT NULL DEFAULT '0',
  `RoleID` int NOT NULL,
  `ModuleID` int NOT NULL,
  `PermissionID` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(9, 9, 'e34f92a20532a873cb3184398070b4b82a8fa29cf48572c203dc5f0fa6158231', NULL, NULL, 1, '2026-06-04 23:46:01', '2026-06-03 06:30:33', '2026-06-04 15:46:01'),
...
--
ALTER TABLE `audit_logs`
  MODIFY `AuditLogID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=237;

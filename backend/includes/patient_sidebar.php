...
<aside class="sidebar sidebar-student" id="sidebar">
 ...
 <nav class="nav-menu">
 <a class="nav-item <?php echo $activeSidebarItem === 'dashboard' ? 'active' : ''; ?>" href="/NUcare_Health_system/frontend/student/dashboard/patient_dashboard.php">
 <span class="nav-icon"><i class="fa-solid fa-house"></i></span>
 Dashboard
 </a>
 <a class="nav-item <?php echo $activeSidebarItem === 'schedule' ? 'active' : ''; ?>" href="/NUcare_Health_system/frontend/student/dashboard/my_schedule.php">
 <span class="nav-icon"><i class="fa-solid fa-calendar-check"></i></span>
 My Schedule
 </a>
 <a class="nav-item <?php echo $activeSidebarItem === 'records' ? 'active' : ''; ?>" href="/NUcare_Health_system/frontend/student/dashboard/my_records.php">
 ...
 <a class="nav-item nav-subitem <?php echo $activeSidebarItem === 'profile' ? 'active' : ''; ?>" href="/NUcare_Health_system/frontend/student/dashboard/profile.php">
 <span class="nav-icon"><i class="fa-solid fa-user"></i></span>
 My Profile
 </a>
 <a class="nav-item nav-subitem <?php echo $activeSidebarItem === 'settings' ? 'active' : ''; ?>" href="/NUcare_Health_system/frontend/student/dashboard/update_password.php">

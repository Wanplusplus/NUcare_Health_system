...
?>
 ...
 <a class="nav-item <?= $activeKey === 'dashboard' ? 'active' : '' ?>" href="/NUcare_Health_system/frontend/admin/dashboard/admin_dashboard.php">
 <span class="nav-dot"></span>Dashboard
 </a>
 <a class="nav-item <?= $activeKey === 'user_management' ? 'active' : '' ?>" href="/NUcare_Health_system/frontend/admin/user_management.php">
 ...
 ?>
 <?php if ($showRbacMenu): ?>
 <a class="nav-item <?= $activeKey === 'rbac_management' ? 'active' : '' ?>" href="/NUcare_Health_system/frontend/admin/rbac_management.php">
 <span class="nav-dot"></span>RBAC Management
 </a>
 <?php endif; ?>
 <a class="nav-item <?= $activeKey === 'reports' ? 'active' : '' ?>" href="/NUcare_Health_system/frontend/admin/reports.php">
 <span class="nav-dot"></span>Reports
 </a>
 <a class="nav-item <?= $activeKey === 'audit_logs' ? 'active' : '' ?>" href="/NUcare_Health_system/frontend/admin/audit_logs.php">

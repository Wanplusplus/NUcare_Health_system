...
try {
 ...
 if (!$hasFailedLogins) {
 $tableHtml .= '<div style="padding:10px 14px; background:#fffbeb; border:1px solid #fde68a; border-radius:6px; color:#92400e; font-size:10px; margin-bottom:14px;">Warning Failed login information is not available in the current audit dataset.</div>';
 }
 ...
 $tableHtml .= '<td>' . ($perms ? 'check ' . e($perms) : '-') . '</td>';
 }
 $tableHtml .= '</tr>';
 }
 $tableHtml .= '</tbody></table>';

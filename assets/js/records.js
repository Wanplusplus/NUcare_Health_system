...
(function () {
 ...
 fetch('/NUcare_Health_system/backend/ajax/get_records.ajax.php')
 .then(r => r.json())
 .then(data => {
 ...
 * (was: /NUcare_Health_system/backend/ajax/get_patient_record.ajax.php)
 */
 ...
 fetch(`/NUcare_Health_system/backend/ajax/get_patient_record.ajax.php?school_person_id=${userID}`)
 .then(r => r.json())
 .then(data => {
 ...
 fetch('/NUcare_Health_system/backend/ajax/records_patient_info_save.ajax.php', { method: 'POST', body })
 .then(r => {
 ...
 fetch(`/NUcare_Health_system/backend/ajax/get_patient_record.ajax.php?school_person_id=${encodeURIComponent(userID)}`)
 .then(rr => rr.json())
 .then(refreshed => {
 ...
 */
 ...
 ${escHtml(m.medicineName || m.MedicineName || 'Medicine')} x${escHtml(String(m.quantityDispensed ?? m.qty ?? ''))}
 </span>`
 ).join('');
 ...
 tx.temperature && detailField('Temperature', tx.temperature + ' degC'),
 ...
 ${e.temperature ? detailField('Temperature', e.temperature + ' degC') : ''}
 ...
 fetch(`/NUcare_Health_system/backend/ajax/consultation/get_transaction.ajax.php?clinic_transaction_id=${encodeURIComponent(transactionID)}`)
 .then(r => r.json())
 .then(resp => {

document.addEventListener('DOMContentLoaded', () => {
 ...
 const apiUrl = '/NUcare_Health_system/backend/ajax/medicine_ajax.php';
...
const getDisplayStatus = (m) => {
 ...
 ? `/NUcare_Health_system/backend/print-output/medicine_output.php?${query}`
 : '/NUcare_Health_system/backend/print-output/medicine_output.php';
 };
 ...
 window.open(
 `/NUcare_Health_system/backend/print-output/individual_medicine_output.php?id=${medicineId}`,
 '_blank',
 'noopener,noreferrer',
 );
}

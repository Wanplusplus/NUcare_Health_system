        ...
        <div class="sim-wrapper">
            ...
            <?php if ($executionResult !== null && $executionResult['status'] === 'success'): ?>
                <div class="success-banner">
                    ...
                    <div>
                        <strong>✔ Lifecycle audit executed successfully.</strong><br>
            ...
            <div class="warning-banner">
                ...
                <span>⚠ THIS TOOL MODIFIES THE DATABASE when confirmed. Preview results first, then confirm to execute.</span>
            </div>

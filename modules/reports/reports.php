...
<form id="pdfForm" method="post" action="../../print-output/medical_staff_report_output.php" target="_blank" style="display:none;">
...
(function () {
    ...
    const endpoint = '../../ajax/medical_staff_reports.ajax.php';
    const state = {
